...
```sh
# 将镜像python:3.8-slim保存为file_python3_8_slim文件
...
把 file1.txt 和 file2.txt 添加到`/app`下
...
把 archive.tar.gz 文件添加到镜像中, 并自动解压到`/app`下
